...
#
# Prints a side-by-side comparison table of the three native binaries that
# the `pgo` Maven profile built and load-tested. Reads metric files written
# by pgo-test-binary.sh from target/comparison/.
